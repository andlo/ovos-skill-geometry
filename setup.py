...
URL = "https://github.com/andlo/ovos-skill-geometry"
SKILL_CLAZZ = "Geometry"
PYPI_NAME = "ovos-skill-geometry"
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="Geometry knowledge for OVOS - shape/term definitions, formulas, and applied calculations, fully offline",
